...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { account_id: @partner.account_id, person_id: @partner.person_id }
    end
  ...
  test "should update partner" do
    patch :update, id: @partner, partner: { account_id: @partner.account_id, person_id: @partner.person_id }
    assert_redirected_to partner_path(assigns(:partner))
  end
